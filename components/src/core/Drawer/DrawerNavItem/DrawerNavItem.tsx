...
const InfoListItemRoot = styled(InfoListItem, {
    ...
    [`&.${drawerNavItemClasses.drawerOpen}`]: {},
    [`&.${drawerNavItemClasses.noIconTitle}`]: {
        opacity: 0,
    ...
    [`&.${drawerNavItemClasses.textSecondary}`]: {
