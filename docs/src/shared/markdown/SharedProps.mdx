...
The following props can be set at any level in the drawer hierarchy ([`<Drawer>`](/components/drawer/drawer/api-docs), [`<DrawerBody>`](/components/drawer/drawer-body/api-docs), [`<DrawerNavGroup>`](/components/drawer/drawer-nav-group/api-docs), [`<DrawerNavItem>`](/components/drawer/drawer-nav-item/api-docs), or [`<DrawerRailItem>`](/components/drawer/drawer-rail-item/api-docs)). If they are set on a parent, they will be used for all children. For more customization, you can set these props on individual children and they will override any value set on the parent.
