...
<CodeBlock sx={{ height: 'auto', fontSize: '14px' }} code={`git --version`} />
...
<CodeBlock sx={{ height: 'auto', fontSize: '14px' }} code={`yarn -v`} />
...
<CodeBlock sx={{ height: 'auto', fontSize: '14px' }} code={`yarn add <package-name>`} />
