...
Whether you are developing a white-labeled product or need to modify a component style across the whole application, theme customization is a great way to tune the default Brightlayer UI theme into exactly what your brand design calls for.

# Changing Individual Component Styles

If your goal is to change Brightlayer UI component styles case by case instead, please refer to our [style overrides guide](https://github.com/etn-ccis/blui-react-component-library/blob/master/docs/src/shared/markdown/StyleOverridesGuide.md). Note, however, that this approach may drive up maintenance cost significantly in the long run, especially when you have to maintain multiple products. The better approach is to build your custom theme.
...
You can fork our [themes repository](https://github.com/etn-ccis/blui-react-themes/tree/master), change it to fit your branding needs, and use your new theme in the `ThemeProvider`. Note, however, that you will not benefit from any future package updates from Brightlayer UI.
