...
If you want to change Brightlayer UI component styles on a case-by-case basis, please refer to our [style overrides guide](https://github.com/etn-ccis/blui-react-component-library/blob/master/docs/src/shared/markdown/StyleOverridesGuide.md). Note, however, that this approach may drive up maintenance costs significantly in the long run, especially if you have to maintain multiple products. The better approach in this scenario is to build a custom theme.
