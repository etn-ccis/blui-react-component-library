...
import { MarkdownCodeBlock } from '../shared';
...
<MarkdownCodeBlock code={`npx -p @brightlayer-ui/cli blui new react`} />
...
<MarkdownCodeBlock code={`npm install --save @mui/material @mui/icons-material @emotion/react @emotion/styled`} />

or

<MarkdownCodeBlock code={`yarn add @mui/material @mui/icons-material @emotion/react @emotion/styled`} />
...
<MarkdownCodeBlock code={`npm install --save @brightlayer-ui/react-components`} />

or

<MarkdownCodeBlock code={`yarn add @brightlayer-ui/react-components`} />
...
<MarkdownCodeBlock code={`npm install --save @brightlayer-ui/react-themes`} />

or

<MarkdownCodeBlock code={`yarn add @brightlayer-ui/react-themes`} />
