...
The `ThreeLiner` can display up to three lines of stylized text or other custom content. It is most commonly used within the context of a [`AppBar`](/components/app-bar/api-docs) component where the text can grow / shrink as the App Bar is expanded and collapsed.
