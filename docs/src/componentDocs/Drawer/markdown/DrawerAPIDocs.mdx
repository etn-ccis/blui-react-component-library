...
| [...sharedProps](/components/drawer/drawer/api-docs#shared-props) | Props that can be set at any level in the drawer hierarchy                   | -                                                            | -        |                   |
