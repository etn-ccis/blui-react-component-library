...
When using the `'rail'` variant of the [Drawer](/components/drawer/examples), navigation items are rendered as `<DrawerRailItem>` components instead of [Drawer Nav Items](/components/drawer/drawer-nav-item/api-docs). If you are using the `items` prop to declare navigation items for your drawer, the correct component will be selected automatically. If you are building your Drawer structure using composition, make sure you use the correct nav/rail item component for your chosen variant.
