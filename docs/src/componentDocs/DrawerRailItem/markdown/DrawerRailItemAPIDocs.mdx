...
| condensed\*                                                          | Show condensed nav items without titles (`rail` variant only)                                   | `boolean`               | no       | `false` |
| hidden                                                               | Sets whether to hide the rail item                                                              | `boolean`               | no       |         |
| icon                                                                 | A component to render the icon                                                                  | `JSX.Element`           | yes      |         |
...
| [...sharedProps](/components/drawer-rail-item/api-docs#shared-props) | Props that can be set at any level in the drawer hierarchy                                      | -                       | -        |         |
