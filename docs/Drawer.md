...
| expanded   | .BluiDrawer-expanded   | Styles applied to the root element when the drawer is expanded |
...
| expanded | .BluiDrawerLayout-expanded \* | Styles applied to the root element when the drawer is expanded |
